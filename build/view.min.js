...
[];this.intro()}};
HUB.Base.prototype={constructor:HUB.Base,init:function(){},intro:function(){this.full=document.createElement("div");this.full.style.cssText="position:absolute; top:0px; left:0px; width:100%; height:100%; pointer-events:none; display:block; background:rgba(23, 141, 214,1); ";this.fullMid=document.createElement("div");this.fullMid.style.cssText="position:absolute; top:10px; left:50%; width:300px; height:300px; margin-left:-150px; pointer-events:none; display:block;";this.title=document.createElement("div");this.title.innerHTML=
...
this.full.appendChild(this.fullMid);this.fullMid.appendChild(this.logo);this.fullMid.appendChild(this.title);this.fullMid.appendChild(this.subtitle);this.hub.appendChild(this.full)},start:function(){this.isIntro&&(this.timer=setInterval(this.fadding,100,this))},fadding:function(a){a.bg-=0.1;a.full.style.background="rgba(23, 141, 214,"+a.bg+")";0>=a.bg&&(clearInterval(a.timer),a.full.removeChild(a.fullMid),a.fullMid.removeChild(a.logo),a.fullMid.removeChild(a.title),a.fullMid.removeChild(a.subtitle),a.hub.removeChild(a.full),a.initStartHub(),a.isIntro=!1)},initStartHub:function(){this.full=document.createElement("div");this.full.style.cssText="position:absolute; top:10px; left:50%; margin-left:-150px; width:300px; height:300px; pointer-events:none;";this.full.id="fullStart";this.hub.appendChild(this.full);var a=this.addButton(this.full,"Play",[276,48,40],"position:absolute; top:10px; left:-680px;"),z=this.addButton(this.full,"Multiplayer",[276,48,40],"position:absolute; top:80px; left:-680px;"),x=this.addButton(this.full,"Statistics",[276,48,40],"position:absolute; top:830px; left:-680px;"),x=this.addButton(this.full,"Forums",[276,48,40],"position:absolute; top:750px; left:-680px;"),x=this.addButton(this.full,"Mods",[276,48,40],"position:absolute; top:570px; left:-680px;"),b=this.addButton(this.full,"New Map",[120,26,22],"position:absolute; top:830px; left:550px;"),x=this.addButton(this.full,"Extras",[276,48,40],"position:absolute; top:490px; left:-680px;"),x=this.addButton(this.full,"Settings",[276,48,40],"position:absolute; top:410px; left:-680px;"),
c=this.addButton(this.full,"Terraform",[120,26,22],"position:absolute; top:830px; left:700px;"),e=this.addButton(this.full,"Load",[276,26,22],"position:absolute; top:150px; left:-680px;");this.addSelector("DIFFICULTY",["LOW","MEDIUM","HARD"],setDifficulty,0);a.addEventListener("click",function(a){a.preventDefault();playMap()},!1);b.addEventListener("click",function(a){a.preventDefault();newMap()},!1);c.addEventListener("click",function(a){a.preventDefault();newHeightMap()},!1);e.addEventListener("click",
...
function(a){a.preventDefault();getBudjet()},!1);this.addButton(this.hub,"Scenario",[75,16,14],"position:absolute; left:710px; top:-7px; font-weight:bold;",!0).addEventListener("click",
function(a){a.preventDefault();a.openExit()},!1);this.addButton(this.hub,"Map",[75,16,14],"position:absolute; left:810px; top:-7px; font-weight:bold;",!0).addEventListener("click",
function(a){a.preventDefault();getBudjet()},!1);
...
function(b){b.preventDefault();a.openExit()},!1);this.addButton(this.hub,"Eval",[75,16,14],"position:absolute; left:110px; top:-7px; font-weight:bold;",!0).addEventListener("click",function(a){a.preventDefault();getEval()},!1);this.addButton(this.hub,"Options",[75,16,14],"position:absolute; left:310px; top:-7px; font-weight:bold;",!0).addEventListener("click",function(b){a.preventDefault();a.openExit()},!1);this.addButton(this.hub,"Race",[75,16,14],"position:absolute; left:410px; top:-7px; font-weight:bold;",
