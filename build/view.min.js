...
a.hub.removeChild(a.full),a.initStartHub(),a.isIntro=!1)},initStartHub:function(){this.full=document.createElement("div");this.full.style.cssText="position:absolute; top:10px; left:50%; margin-left:-150px; width:300px; height:300px; pointer-events:none;";this.full.id="fullStart";this.hub.appendChild(this.full);var a=this.addButton(this.full,"Play",[276,48,40],"position:absolute; top:10px; left:0px;"),z=this.addButton(this.full,"Multiplayer",[276,48,40],"position:absolute; top:80px; left:0px;"),x=this.addButton(this.full,"Statistics",[276,48,40],"position:absolute; top:800px; left:-600px;"),x=this.addButton(this.full,"Mods",[276,48,40],"position:absolute; top:800px; left:-300px;"),x=this.addButton(this.full,"Forums",[276,48,40],"position:absolute; top:800px; left:0px;"),b=this.addButton(this.full,"New Map",[120,26,22],"position:absolute; top:270px; left:0px;"),x=this.addButton(this.full,"Extras",[276,48,40],"position:absolute; top:800px; left:300px;"),x=this.addButton(this.full,"Settings",[276,48,40],"position:absolute; top:800px; left:600px;"),
